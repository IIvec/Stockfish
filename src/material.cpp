...
namespace {
  ...
  int CubicOurs[][PIECE_TYPE_NB][PIECE_TYPE_NB] = {
    // OUR PIECES:
    {}, // Bishop pair
    {   // Pawn
        //            OUR PIECES
  ...
  int CubicTheirs[][PIECE_TYPE_NB][PIECE_TYPE_NB] = {
    // OUR PIECES:
    {}, // Bishop pair
    {   // Pawn
        //            THEIR PIECES
  ...
  TUNE(SetRange(centered_range), Linear, QuadraticOurs, QuadraticTheirs, CubicOurs, CubicTheirs);
