...
enum Value {
  ...
  KnightValueMg = 814,   KnightValueEg = 849,
  BishopValueMg = 837,   BishopValueEg = 857,
  RookValueMg   = 1270,  RookValueEg   = 1280,
  QueenValueMg  = 2498,  QueenValueEg  = 2552,

  MidgameLimit  = 15598, EndgameLimit  = 4000
};
