...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(267,0), S(320,50), S(270,78), S(195,87) },
   { S(264,45), S(304,96), S(238,149), S(180,137) },
   { S(200,86), S(245,144), S(176,174), S(110,172) },
   { S(177,110), S(185,176), S(148,176), S(110,186) },
   { S(149,112), S(177,170), S(115,208), S(66,211) },
   { S(118,99), S(159,161), S(84,183), S(41,181) },
   { S(86,52), S(128,103), S(63,127), S(18,145) },
   { S(63,9), S(89,57), S(47,83), S(0,94) }
  }
};
